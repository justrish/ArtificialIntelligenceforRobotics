...
gtPath = '../CamVid/testannot'; % path to your ground truth images
predPath = '../Models/bayesian_segnet_camvid/predictions'; %path to your predictions (you get them after you implement saving images in the test_segmentation_camvid.py script - or you write your own)
